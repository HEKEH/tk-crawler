...
export const AREA_OPTIONS: AreaOption[] = [
  { label: '美国及加拿大', value: Area.US },
  { label: '英国及相关国家', value: Area.UK_PLUS },
  { label: '中东及北非', value: Area.MENA },
  { label: '俄罗斯及独联体', value: Area.RU_PLUS },
  { label: '拉丁美洲', value: Area.LATAM },
  { label: '德国及周边国家', value: Area.DE_PLUS },
  { label: '法国及相关国家', value: Area.FR_PLUS },
  { label: '西班牙及相关国家', value: Area.ES_PLUS },
  { label: '日本', value: Area.JP },
  { label: '韩国', value: Area.KR },
  { label: '澳洲', value: Area.AU_PLUS },
