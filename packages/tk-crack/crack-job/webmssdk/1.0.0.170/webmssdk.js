!(function (e, t) {
    ...
    Fb[5] == typeof exports && Fb[1] != typeof module
        ? t(exports)
        : Fb[4] == typeof define && define[Fb[0]]
        ? define([Fb[2]], t)
        : t(
              ((e = Fb[1] != typeof globalThis ? globalThis : e || self)[
                  Fb[3]
              ] = {}),
          );
        ...
        switch (Eb) {
                    ...
                    do {
                        if (!d) {
                            ...
                            if (1 == m) (d = af), (p = _e), (v = 9), (y = 5);
                                ...
                                f += 14;
                                for (
                                    var P = new u8(R), T = new u8(19), A = 0;
                                    A < w;
                                    ++A
                                )
                                    T[df[A]] = Ze(e, f + 3 * A, 7);
                    ...
                    (function () {
                        var Db = [
                            function (e) {
                                var sa;
                                sa = [
                                    5, 14, 10, 1, 6, 15, 9, 0, 8, 3, 12, 13, 11,
                                    4, 7, 16, 2,
                                ];
                                if (e)
                                    (tf[sa[7]] =
                        ...
                        (Db[0].prototype['hash'] = function () {
                            ...
                            ((ta = [
                                1804603682, 14, 26, 1120210379, 1, 30611744,
                                1990404162, 16, 358537222, 1735328473, 28,
                                117830708, 378558, 1926607734, 343485551,
                                680876937, 389564586, 722521979, 8, 1316259209,
                                5, 718787259, 1770035416, 1700485571, 3,
                                165796510, 35309556, 17, 27, 606105819, 6,
                                1272893353, 643717713, 1051523, 2, 1732584194,
                                660478335, 198630844, 421815835, 1873313359, 21,
                                9, 13, 1894986606, 20, 640364487, 680876936,
                                1094730640, 1163531501, 22, 1044525330, 25,
                                1732584193, 1236535329, 2004318071, 271733879,
                                11, 2054922799, 40341101, 0, 2022574463,
                                1126891415, 1200080426, 18, 1444681467, 4, 10,
                                681279174, 1530992060, 176418897, 405537848,
                                145523070, 271733878, 38016083, 1839030562, 12,
                                1019803690, 373897302, 51403784, 1069501632,
                                1473231341, 45705983, 76029189, 568446438, 15,
                                23, 42063, 1958414417, 155497632, 995338651,
                                1560198380, 1502002290, 1126478375, 701558691,
                                57434055, 1416354905, 187363961, 7, 1309151649,
                                530742520,
                            ]),
                            (i = this['blocks'])),
                                (this['first']
            ...
            case 'Ut':
                ...
                function Ab24(e, t) {
                    var u, ib;
                    ib = [0];
                    for (var r, n = [], o = 0, a = '', i = 0; i < 256; i++)
                        n[i] = i;
                    for (var s = 0; s < 256; s++)
                        (o =
                            (o + n[s] + e['charCodeAt'](s % e['length'])) %
                            256),
                            (r = n[s]),
                            (n[s] = n[o]),
                            (n[o] = r);
                ...
                function Ab26(e, t) {
                    ...
                    for (
                        ...
                        for (
                            a = ((o = Ab30(o + Hd)) >>> 2) & 3, i = 0;
                            i < l;
                            ++i
                        )
                            (r = e[i + 1]),
                                (n = e[i] =
                                    Ab30(e[i] + Ab18(o, r, n, i, a, t)));
                        (r = e[0]),
                            (n = e[l] = Ab30(e[l] + Ab18(o, r, n, l, a, t)));
                    }
                    return e;
                }
                function Ab27(e) {
                            ...
                            switch (e) {
                                ...
                                case 7: {
                                    var P = i[c++],
                                        T = [void 0];
                                    while (P > 0)
                                        T[P--] = stack[stackPointer--];
                                    var A = stack[stackPointer--],
                                        E = new (Function.bind['apply'](
                                            A,
                                            T,
                                        ))();
                                ...
                                case 47: {
                                    k = stack[stackPointer--];
                                    stack[stackPointer] =
                                        stack[stackPointer] instanceof k;
                                    break;
                                }
                                case 48:
                                    stack[stackPointer] =
                ...
                function Ab34(e, t, r) {
                    ...
                    return (
                        Ab15(e, t, n), String.fromCharCode['apply'](String, n)
                    );
                }
                function Ab35(e) {
                    var qb;
                ...
                function Ab74(e, t, r) {
                    ...
                    for (
                        var s = r['length'] - o, u = Ab9(n, t), l = 0;
                        l < s;
                        ++l
                    )
                        r[o + l] ^= u[l];
                    ...
                    return (
                        ...
                        eb[1] == e || eb[0] === e['length']
                            ...
                            : ((e = Ab83(e)),
                              (t = Ab83(t)),
                              Ab80(
                                  Ab26(Ab10(e, !eb[0]), Ab66(Ab10(t, !eb[2]))),
                                  !eb[2],
                              ))
                    );
                }
                ...
                function initAndExecuteByteCode(bytecodeIndex, t, n, i) {
                    ...
                    const res = jsvmp(
                        BytecodeDefinitions[bytecodeIndex],
                        t,
                        n,
                        i,
                    );
